...
@Component({
  selector: 'app-visiteur-display-event',
  templateUrl: './visiteur-display-event.component.html',
  styleUrls: ['./visiteur-display-event.component.css']
})
export class VisiteurDisplayEventComponent implements OnInit {
  id:any;
  events:any;
  event:any;
  userConnect:any;
